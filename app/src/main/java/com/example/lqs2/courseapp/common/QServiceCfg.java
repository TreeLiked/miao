package com.example.lqs2.courseapp.common;

import android.content.Context;
import android.widget.Toast;

import com.example.lqs2.courseapp.ObjectSample.LocalCredentialProvider;
...
public class QServiceCfg {
   ...
   private String downloadDir;
    ...
    private QServiceCfg(Context context){
         ...
         * 2. 用永久密钥和一个有效期生成的临时密钥 可以参考{@link ShortTimeCredentialProvider}
         * 此处只是示例，出于安全考虑客户端不应该缓存 secretKey，生成密钥的过程建议放到server端
         */
        /** 初始化服务类 CosXmlService */

        long keyDuration = 3600; //secretKey 的有效时间,单位秒
...
//                new ShortTimeCredentialProvider(secretId,secretKey,localCredentialProvider));
    ...
    public static LocalCredentialProvider localCredentialProvider(long sec) {

        return new LocalCredentialProvider("AKIDFKRetDGBkLzXu4iVt67zoTwpjw8OcQ9g", "TtAIF0Y7YM1UXcdXJtKdppdFf2DF4hEx", sec);
    }
...
//        }
    ...
    public void setGetCosPath(String getCosPath) {
        this.getCosPath = getCosPath;
    }


    public void setUploadCosPath(String uploadCosPath) {
        this.uploadCosPath = uploadCosPath;
    }
